...
ns = api.namespace('iris', description='Iris classification model')
parser = ns.parser()
...
class Iris(Resource):
    ...
    def get():
        json_arr = eval(request.args.get('input_data'))
        ...
        # label dictionary
        class_dic = {0: "Iris-setosa", 1: "Iris-versicolor", 2: "Iris-virginica"}
    ...
    @staticmethod
    def post(input_data):
        return "post response and input_data = [" + str(input_data) + "]"
...
def custom_alarm():
    ...
    if log_info['latest_log']['status_code'] != 200: message.append("Iris classification api call failed")
